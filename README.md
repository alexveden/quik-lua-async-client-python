...
- Клиент **не поддерживает** подписку на события, т.к. QuikLuaRPC имеет тенденцию пихать все события сразу без какой-либо фильтрации
...
Версия: ранняя альфа 0.0.0.3, в разработке.
